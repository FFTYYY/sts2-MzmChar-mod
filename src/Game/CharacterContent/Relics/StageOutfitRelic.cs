...
public class StageOutfitRelic : CustomRelicModel
{
    ...
    public override async Task AfterPlayerTurnStart(PlayerChoiceContext ctx, Player player)
    {
        ...
        await CreatureCmd.GainBlock(Owner.Creature, 15, ValueProp.Move | ValueProp.Unpowered, null, false);
    }
    ...
    public override List<(string, string)>? Localization => LocManager.Instance.Language switch
    {
        "zhs" => new RelicLoc(
            Title:       "演出服",
            Description: "进入[gold]演奏会[/gold]时，获得15点[gold]格挡[/gold]。",
            Flavor:      "哥特风格的演出服。"),
        _ => new RelicLoc(
            Title:       "Stage Outfit",
            Description: "When you enter [gold]Concert[/gold], gain 15 [gold]Block[/gold].",
