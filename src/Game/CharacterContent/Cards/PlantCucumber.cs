...
/// <summary>种植黄瓜：2 费蓝色能力。回合开始按形态触发：Mu +6/8 格挡 / Mo +6/8 活力（见 PlantCucumberPower）。
...
public class PlantCucumber : MzmCharBaseCard
{
    ...
    private readonly List<DynamicVar> _vars = new()
    {
        ...
        new DynamicVar("MoVigor", 6m),    // 升级 +2 → 8
    };
    ...
    protected override void OnUpgrade()
    {
        ...
        DynamicVars["MoVigor"].UpgradeValueBy(2);    // 6 → 8
    }
    ...
    protected override async Task OnPlay(PlayerChoiceContext ctx, CardPlay play)
    {
        ...
        await PowerCmd.Apply<PlantCucumberPower>(Owner.Creature, 1, Owner.Creature, this, false);
